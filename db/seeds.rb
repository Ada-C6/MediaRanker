...
albums = [
  {name: "The #{colors.sample.capitalize} Album", artist: "#{first_names.sample.capitalize} #{last_names.sample.capitalize}" , description: "This album is #{adjectives.sample}!", rank_points: 0 },
  {name: "The #{colors.sample.capitalize} Album", artist: "#{first_names.sample.capitalize} #{last_names.sample.capitalize}", description: "This album is #{adjectives.sample}!", rank_points: 0 },
  {name: "The #{colors.sample.capitalize} Album", artist: "#{first_names.sample.capitalize} #{last_names.sample.capitalize}", description: "This album is #{adjectives.sample}!", rank_points: 0 },
  {name: "The #{colors.sample.capitalize} Album", artist: "#{first_names.sample.capitalize} #{last_names.sample.capitalize}", description: "This album is #{adjectives.sample}!", rank_points: 0 },
  {name: "The #{colors.sample.capitalize} Album", artist: "#{first_names.sample.capitalize} #{last_names.sample.capitalize}" , description: "This album is #{adjectives.sample}!", rank_points: 0 },
...
books = [
  {name: "The Chronicle of a #{nouns.sample.capitalize}", author: "#{first_names.sample.capitalize} #{last_names.sample.capitalize}", description: "This book was really #{adjectives.sample}!", rank_points: 0 },
  {name: "The Chronicle of a #{nouns.sample.capitalize}", author: "#{first_names.sample.capitalize} #{last_names.sample.capitalize}", description: "This book was really #{adjectives.sample}!" , rank_points: 0 },
  {name: "The Chronicle of a #{nouns.sample.capitalize}", author: "#{first_names.sample.capitalize} #{last_names.sample.capitalize}", description: "This book was really #{adjectives.sample}!" , rank_points: 0 },
  {name: "The Chronicle of a #{nouns.sample.capitalize}", author: "#{first_names.sample.capitalize} #{last_names.sample.capitalize}", description: "This book was really #{adjectives.sample}!" , rank_points: 0 },
  {name: "The Chronicle of a #{nouns.sample.capitalize}", author: "#{first_names.sample.capitalize} #{last_names.sample.capitalize}", description: "This book was really #{adjectives.sample}!" , rank_points: 0 },
...
movies = [
  {name: "The #{gerunds.sample.capitalize} #{nouns.sample.capitalize}", director: "#{first_names.sample.capitalize} #{last_names.sample.capitalize}", description: "This movie was #{adjectives.sample}", rank_points: 0 },
  {name: "The #{gerunds.sample.capitalize} #{nouns.sample.capitalize}", director: "#{first_names.sample.capitalize} #{last_names.sample.capitalize}", description: "This movie was #{adjectives.sample}", rank_points: 0 },
  {name: "The #{gerunds.sample.capitalize} #{nouns.sample.capitalize}", director: "#{first_names.sample.capitalize} #{last_names.sample.capitalize}", description: "This movie was #{adjectives.sample}", rank_points: 0 },
  {name: "The #{gerunds.sample.capitalize} #{nouns.sample.capitalize}", director: "#{first_names.sample.capitalize} #{last_names.sample.capitalize}", description: "This movie was #{adjectives.sample}", rank_points: 0 },
  {name: "The #{gerunds.sample.capitalize} #{nouns.sample.capitalize}", director: "#{first_names.sample.capitalize} #{last_names.sample.capitalize}", description: "This movie was #{adjectives.sample}", rank_points: 0 }
